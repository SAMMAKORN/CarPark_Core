        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuotaPerDay = table.Column<int>(type: "int", nullable: true),
                    WaiveOvernightPenalty = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParkingConditions_Users_CreateBy",
                        column: x => x.CreateBy,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ParkingConditions_Users_DeletedBy",
                        column: x => x.DeletedBy,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ParkingConditions_Users_UpdateBy",
                        column: x => x.UpdateBy,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingStartTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    BillingEndTime = table.Column<TimeSpan>(type: "time", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "ParkingConditionLots",
                columns: table => new
                {
                    ParkingConditionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParkingLotId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingConditionLots", x => new { x.ParkingConditionId, x.ParkingLotId });
                    table.ForeignKey(
                        name: "FK_ParkingConditionLots_ParkingConditions_ParkingConditionId",
                        column: x => x.ParkingConditionId,
                        principalTable: "ParkingConditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParkingConditionLots_ParkingLots_ParkingLotId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParkingConditionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreateBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingTransactions_ParkingConditions_ParkingConditionId",
                        column: x => x.ParkingConditionId,
                        principalTable: "ParkingConditions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreateAt", "CreateBy", "DeleteAt", "DeletedBy", "IsActive", "IsDeleted", "MustChangePassword", "Name", "Password", "Role", "UpdateAt", "UpdateBy", "Username" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, true, false, false, "System Admin", "PBKDF2$SHA256$100000$CNMtqGjCwsaY4gv7R9CXhw==$lGxIuuvrpQU4rT2dzxg8Y7sbv2kmTK8mG2kMgrOUMc4=", 0, null, null, "admin" });

            migrationBuilder.CreateIndex(
                name: "IX_ParkingConditionLots_ParkingLotId",
                table: "ParkingConditionLots",
                column: "ParkingLotId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingConditions_CreateBy",
                table: "ParkingConditions",
                column: "CreateBy");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingConditions_DeletedBy",
                table: "ParkingConditions",
                column: "DeletedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingConditions_UpdateBy",
                table: "ParkingConditions",
                column: "UpdateBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingTransactions_ParkingConditionId",
                table: "ParkingTransactions",
                column: "ParkingConditionId");
