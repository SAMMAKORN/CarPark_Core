...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarPark.Models.ParkingCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<bool>("WaiveOvernightPenalty")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("ParkingConditions");
                });

            modelBuilder.Entity("CarPark.Models.ParkingConditionLot", b =>
                {
                    b.Property<Guid>("ParkingConditionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ParkingLotId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ParkingConditionId", "ParkingLotId");

                    b.HasIndex("ParkingLotId");

                    b.ToTable("ParkingConditionLots");
                });
            ...
            modelBuilder.Entity("CarPark.Models.ParkingLot", b =>
                {
                    ...
                    b.Property<TimeSpan?>("BillingEndTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan?>("BillingStartTime")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("CarPark.Models.ParkingConditionLot", b =>
                {
                    b.HasOne("CarPark.Models.ParkingCondition", "Condition")
                        .WithMany("ConditionLots")
                        .HasForeignKey("ParkingConditionId")
            ...
            modelBuilder.Entity("CarPark.Models.ParkingTransaction", b =>
                {
                    ...
                    b.HasOne("CarPark.Models.ParkingCondition", "ParkingCondition")
                        .WithMany()
                        .HasForeignKey("ParkingConditionId")
                        .OnDelete(DeleteBehavior.NoAction);
